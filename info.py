...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003318822667'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003318822667'))  # Premium logs channel id
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003318822667')  # Request channel id (make sure bot is admin)
