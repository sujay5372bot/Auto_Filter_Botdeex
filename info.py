...
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://graph.org/file/e20b5fdaf217252964202.jpg")
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1004329415234'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1004329415234'))  # Premium logs channel id
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1004329415234')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/onefighterarmy')  # Support group link (make sure bot is admin)
...
auth_channels     = environ.get("AUTH_CHANNELS", "-1002522695655")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://image-link.edgeone.app/1790220671152-4fgfs2.jpg')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'sujay5372@slc')    # Owner UPI ID for payments
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Sjdjhdbdbd:Sjdjhdbdbd@cluster0836483846.qj2ol2r.mongodb.net/?appName=Cluster0836483846")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "techvjautobot") # Database name (default: cluster)
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'techvjcollection') # Collection name (default: dreamcinezone_files)

# If MULTIPLE_DB Is True Then Fill DATABASE_URI2 Value Else You Will Get Error.
MULTIPLE_DB = is_enabled(os.environ.get('MULTIPLE_DB', "True"), True) # Type True For Turn On MULTIPLE DB FUNTION 
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://sujay53721_db_user:sujay53721_db_user@cluster07373646563737.h6q6n5f.mongodb.net/?appName=Cluster07373646563737")  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002157033795'))  # Notification of sent to your channel
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/onefighterarmy")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/onefighterarmy")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/onefighterarmy")   # Third tutorial link for verification
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/sujay8372') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/onefighterarmy') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/sujay8372') # Update channel link for the bot
